/*
 *      $Id: clnt_tcp.c,v 4.2 1994/09/29 23:48:50 jraja Exp $
 *
 *      Implements a TCP/IP based, client side RPC.
 *
...
static enum clnt_stat	clnttcp_call(CLIENT * h, u_long proc,
...
static bool_t		clnttcp_freeres(CLIENT * cl, 
					xdrproc_t xdr_res, caddr_t res_ptr);
static bool_t           clnttcp_control(CLIENT * cl,
